const projectsInformation = [
  {
    name: 'Gif Maker',
    websiteLink: 'https://gifmaker.snapbit.in',
    scourceLink: 'https://github.com/KakaShI06/gifmaker',
    smallDescription: 'Convert Videos To Gifs In Seconds',
    projectPic:
      'https://res.cloudinary.com/doql129vl/image/upload/v1694690128/gifmaker-ss_vcylqq.png',
    description:
  ...
  },
  {
    ...
    websiteLink: 'https://www.youtube.com/shorts/y3vFDS6K6TU',
    scourceLink: 'https://github.com/KakaShI06/reddit_automation',
    smallDescription: 'Reddit Automation to Create Reels or Youtube Shorts',
    projectPic:
